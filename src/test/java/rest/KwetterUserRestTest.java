...
public class KwetterUserRestTest {
    ...
    public void testCreate() {
        try {
            KwetterUser kwetteruser = new KwetterUser("UserRestTest", null, new ArrayList<KwetterUser>(), new ArrayList<>(), "bio", "website", "locatie", new ArrayList<>(), Roles.Moderator);
            kwetteruser = given()
    ...
    public void testUpdate() {
        KwetterUser kwetteruser = new KwetterUser("UserRestTest", null, new ArrayList<KwetterUser>(), new ArrayList<KwetterUser>(), "bio", "website", "locatie", new ArrayList<>(), Roles.User);
        kwetteruser = given()
                .contentType(ContentType.JSON)
                .body(kwetteruser)
                .when()
    ...
    public void testGetKwetterUser() {
        KwetterUser kwetteruser = new KwetterUser("name", null, new ArrayList<KwetterUser>(), new ArrayList<KwetterUser>(), "bio", "website", "locatie", new ArrayList<>(), Roles.User);
        kwetteruser = given()
                .contentType(ContentType.JSON)
                .body(kwetteruser)
                .when()
    ...
    public void followTest() {
        try {
            KwetterUser kwetteruser = new KwetterUser("UserRestTest", null, new ArrayList<KwetterUser>(), new ArrayList<>(), "bio", "website", "locatie", new ArrayList<>(), Roles.Moderator);
            KwetterUser kwetteruser2 = new KwetterUser("user2", null, new ArrayList<KwetterUser>(), new ArrayList<KwetterUser>(), "bio", "website", "locatie", new ArrayList<>(), Roles.User);
            kwetteruser = given()
                    .contentType(ContentType.JSON)
                    .body(new ObjectMapper().writeValueAsString(kwetteruser))
                    .when()
            ...
            kwetteruser2 = given()
                    ...
                    .body(kwetteruser2)
                    .when()
                    .put("http://localhost:8080/Kwetter/webapi/users/follow/" + kwetteruser.getId())
                    .then()
                    .statusCode(200)
                    .extract()
                    .body()
                    .as(KwetterUser.class);
            usersToDelete.add(kwetteruser);
            usersToDelete.add(kwetteruser2);
        } catch (JsonProcessingException ex) {
            Logger.getLogger(KwetterUserRestTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void unfollowTest() {
        try {
            ...
            kwetteruser2 = given()
                    ...
                    .body(kwetteruser2)
                    .when()
                    .put("http://localhost:8080/Kwetter/webapi/users/unfollow/" + kwetteruser.getId())
                    .then()
                    .statusCode(200)
                    .extract()
                    .body()
                    .as(KwetterUser.class);
            Assert.assertTrue(kwetteruser2.getFollowing().isEmpty());
            usersToDelete.add(kwetteruser);
            usersToDelete.add(kwetteruser2);
        } catch (JsonProcessingException ex) {
            Logger.getLogger(KwetterUserRestTest.class.getName()).log(Level.SEVERE, null, ex);
